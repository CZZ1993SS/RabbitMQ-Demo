package com.rabbit.rabbitboot.config;

import com.rabbit.rabbitboot.hello.UserReceiver;
...
public class RabbitConfig {
    ...
    /**
     * 使用了 RabbitMQ 系统默认的交换器，绑定键即为队列名称
     */
    @Bean
    ...
    public Binding bindingEmailExchangeMessage() {
        ...
        return BindingBuilder.bind(queueEmailMessage())
                             .to(exchange())
                             .with("sb.*.email");
    ...
    public Binding bindingUserExchangeMessages() {
        ...
        return BindingBuilder.bind(queueUserMessages())
                             .to(exchange())
                             .with("sb.*.user");
